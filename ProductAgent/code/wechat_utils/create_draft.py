...
from configs import SOFTWARE_EXPRESS_ROOT_PATH, WECHAT_APP_ID, WECHAT_APP_SECRET
...
class WeChatDraftCreator:
    ...
    def create_draft(self, 
        ...
        if comp_type == "app_express":
            ...
            # 读取HTML内容
            html_file_path = f"{data_dir}/zh_all_software_express.html"
        ...
        payload = {
            "articles": [{
                ...
                "title": article_title,
                "author": "宅小A",
                "digest": f"ProductHunt产品速递 | {year}年第{week}周热门创新产品",
...
if __name__ == "__main__":
    ...
    args.add_argument("--title", type=str, default="ProductHunt产品速递 | 2025年第25周AI精选热门产品", help="标题")
